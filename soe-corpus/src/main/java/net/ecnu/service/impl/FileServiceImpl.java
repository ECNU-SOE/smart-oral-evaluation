...
public class FileServiceImpl implements FileService {
    ...
    public Result evaluate(MultipartFile audio, String text, String pinyin, String mode) {
        ...
        try {
            ...
            File file = FileUtil.MultipartFile2File(audio);
...
//                String base64Str = new sun.misc.BASE64Encoder().encode(buf);
                ...
                result.setSuggestedScore(Float.parseFloat(resp.getSuggestedScore().toString()));
                result.setPronAccuracy(Float.parseFloat(resp.getPronAccuracy().toString()));
                result.setPronFluency(Float.parseFloat(resp.getPronFluency().toString()));
                result.setPronCompletion(Float.parseFloat(resp.getPronCompletion().toString()));
