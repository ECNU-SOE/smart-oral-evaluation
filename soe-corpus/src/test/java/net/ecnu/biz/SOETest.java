...
//                String base64Str = new sun.misc.BASE64Encoder().encode(buf);
    ...
    @Test
    public void IDTest() {
        String token = "soe-token-eyJhbGciOiJIUzI1NiJ9..TUKzEZOOQEwo1I4jiYeIsvGPyOGb3Ll_EueZUbW9Ur4";
        String accountNo = "user_1587395702114357248";
        JsonData name = userFeignService.getName(accountNo, token);
