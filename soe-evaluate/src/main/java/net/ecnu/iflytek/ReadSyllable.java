...
public class ReadSyllable extends WebSocketListener {
    ...
    private static final String category="read_syllable";//题型
    private String text="好";//评测试题,英文试题:[content]\nthere was a gentleman live near my house.

    //private static  String file;

    private static final String file = "C:\\Users\\Lenovo\\Desktop\\smart-oral-evaluation-main\\soe-evaluate\\src\\main\\resources\\static\\iseAudio\\syllable\\read_syllable_cn.pcm";//评测音频,如传mp3格式请改变参数aue的值为lame
    ...
    public ReadSyllable() throws IOException {
    }
    ...
    public void startTest() throws Exception {
        ...
        WebSocket webSocket = client.newWebSocket(request, new ReadSyllable());
    }
            ...
            if (resp.getData() != null) {
                ...
                if (resp.getData().getStatus() == 2) {
                    try {
                        ...
                        Element read_syllable = root.element("read_syllable").element("rec_paper").element("read_syllable");
                        Attribute phone_score = read_syllable.attribute("phone_score");
                        System.out.println(phone_score.getValue());
                        System.out.println(read_syllable.asXML());
