...
public class ReadWord extends WebSocketListener {
    ...
    private static final String category="read_word";//题型
    private String text="漂亮";//评测试题,英文试题:[content]\nthere was a gentleman live near my house.

    //private static  String file;

    private static final String file = "C:\\Users\\Lenovo\\Desktop\\smart-oral-evaluation-main\\soe-evaluate\\src\\main\\resources\\static\\iseAudio\\word\\read_word_cn.pcm";//评测音频,如传mp3格式请改变参数aue的值为lame
    ...
    public ReadWord() throws IOException {
    }
    ...
    public void startTest() throws Exception {
        ...
        WebSocket webSocket = client.newWebSocket(request, new ReadWord());
    }
            ...
            if (resp.getData() != null) {
                ...
                if (resp.getData().getStatus() == 2) {
                    try {
                        ...
                        Element read_word = root.element("read_word").element("rec_paper").element("read_word");
                        Attribute phone_score = read_word.attribute("phone_score");
                        System.out.println(phone_score.getValue());
                        System.out.println(read_word.asXML());
