...
public class FileServiceImpl implements FileService {
    @Override
    public Result sentenceEvaluete(MultipartFile audio) {
...
//                String base64Str = new sun.misc.BASE64Encoder().encode(buf);
    ...
    @Override
    public Result wordEvaluate(MultipartFile audio) {
        Result result = new Result();
        try {
            //String file = "C:\\Users\\Lenovo\\Desktop\\smart-oral-evaluation-main\\soe-evaluate\\src\\main\\resources\\static\\iseAudio\\sentence\\read_sentence_cn.mp3"; //本地音频文件
            //byte[] data = Files.readAllBytes(Paths.get(file));
            File file = this.getFile(audio);
            //byte[] data1 = this.File2byte(file1);
...
//                String base64Str = new sun.misc.BASE64Encoder().encode(buf);
    ...
    @Override
    public Result chapterEvaluate(MultipartFile audio) {
        Result result = new Result();
        try {
            //String file = "C:\\Users\\Lenovo\\Desktop\\smart-oral-evaluation-main\\soe-evaluate\\src\\main\\resources\\static\\iseAudio\\sentence\\read_sentence_cn.mp3"; //本地音频文件
            //byte[] data = Files.readAllBytes(Paths.get(file));
